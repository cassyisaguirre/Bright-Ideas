  ...
  var loadMyCartEvent = function (targetSelector) {
    ...
    if (!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<h4 class="modal-title" id="myModalLabel"><span class="glyphicon glyphicon-shopping-cart bx bx-cart"></span> My Cart</h4>' +
        '</div>' +
        ...
        '<a class="btn btn-primary btn-success" href="paymentstyle.html">Checkout</a>'+
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>'
